...
<head>
    ...
    <link href="${pageContext.request.contextPath }/adminJSP/css/plugins/iCheck/custom.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- Peity -->
    <script src="${pageContext.request.contextPath }/adminJSP/js/plugins/peity/jquery.peity.min.js"></script>
    <!-- 自定义js -->
    <script src="${pageContext.request.contextPath }/adminJSP/js/content.js?v=1.0.0"></script>
    <!-- iCheck -->
    <script src="${pageContext.request.contextPath }/adminJSP/js/plugins/iCheck/icheck.min.js"></script>
    <!-- Peity -->
    <script src="${pageContext.request.contextPath }/adminJSP/js/demo/peity-demo.js"></script>
    <script>
