...
//            app下载
        ...
        function paging(index){
            ...
            var li = document.getElementsByClassName("active1");
            var a = li[index].getElementsByTagName("a");
            var nowPage =index;
           
            for(var i = 0; i < li.length; i ++ ){
                li[i].style.backgroundColor="white";

                li[i].getElementsByTagName("a")[0].style.color="black";
            }

            li[index].style.backgroundColor="#ef4238";
