            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="cinemaForm" action="" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">电影院电话：</label>
                            <div class="col-sm-8">
                                <input id="cinemaPhone" name="phone" type="text" class="form-control" >
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-3 control-label">电影院服务：</label>
                            <div class="col-sm-8">
                                <input id="cinemaServer" name="server" type="text" class="form-control" >
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-3 control-label">服务内容：</label>
                            <div class="col-sm-8">
                                <input id="cinemaServerContext" name="context" type="text" class="form-control" >
                            </div>
                        </div>
                        <div class="form-group">
