...
<div class="header">
    <div class="header-inner" style="left: 0px;">
        ...
        <div class="city-container" data-val="{currentcityid:547}">
            ...
            <div class="city-list" data-val="{ localcityid: 547}">
                ...
                <ul>
                    ...
                    <li>
                        <span>B</span>
                        <div>
                            <a class="js-city-name" data-ci="1" data-val="{ choosecityid:1 }" data-act="cityChange-click">北京</a>
                            <a class="js-city-name" data-ci="84" data-val="{ choosecityid:84 }" data-act="cityChange-click">保定</a>
                            <a class="js-city-name" data-ci="88" data-val="{ choosecityid:88 }" data-act="cityChange-click">蚌埠</a>
                            <a class="js-city-name" data-ci="140" data-val="{ choosecityid:140 }" data-act="cityChange-click">包头</a>
                            <a class="js-city-name" data-ci="153" data-val="{ choosecityid:153 }" data-act="cityChange-click">本溪</a>
                            <a class="js-city-name" data-ci="146" data-val="{ choosecityid:146 }" data-act="cityChange-click">巴彦淖尔</a>
                            <a class="js-city-name" data-ci="167" data-val="{ choosecityid:167 }" data-act="cityChange-click">白城</a>
                            <a class="js-city-name" data-ci="165" data-val="{ choosecityid:165 }" data-act="cityChange-click">白山</a>
                            <a class="js-city-name" data-ci="204" data-val="{ choosecityid:204 }" data-act="cityChange-click">亳州</a>
                            <a class="js-city-name" data-ci="233" data-val="{ choosecityid:233 }" data-act="cityChange-click">滨州</a>
                            <a class="js-city-name" data-ci="317" data-val="{ choosecityid:317 }" data-act="cityChange-click">巴中</a>
                            <a class="js-city-name" data-ci="292" data-val="{ choosecityid:292 }" data-act="cityChange-click">北海</a>
                            <a class="js-city-name" data-ci="297" data-val="{ choosecityid:297 }" data-act="cityChange-click">百色</a>
                            <a class="js-city-name" data-ci="327" data-val="{ choosecityid:327 }" data-act="cityChange-click">毕节</a>
                            <a class="js-city-name" data-ci="332" data-val="{ choosecityid:332 }" data-act="cityChange-click">保山</a>
                            <a class="js-city-name" data-ci="353" data-val="{ choosecityid:353 }" data-act="cityChange-click">宝鸡</a>
                            <a class="js-city-name" data-ci="363" data-val="{ choosecityid:363 }" data-act="cityChange-click">白银</a>
                            <a class="js-city-name" data-ci="393" data-val="{ choosecityid:393 }" data-act="cityChange-click">巴州</a>
                            <a class="js-city-name" data-ci="392" data-val="{ choosecityid:392 }" data-act="cityChange-click">博尔塔拉</a>
                            <a class="js-city-name" data-ci="533" data-val="{ choosecityid:533 }" data-act="cityChange-click">滨海</a>
                            <a class="js-city-name" data-ci="602" data-val="{ choosecityid:602 }" data-act="cityChange-click">宝应</a>
                            <a class="js-city-name" data-ci="681" data-val="{ choosecityid:681 }" data-act="cityChange-click">北流</a>
                            <a class="js-city-name" data-ci="698" data-val="{ choosecityid:698 }" data-act="cityChange-click">博爱</a>
                            <a class="js-city-name" data-ci="731" data-val="{ choosecityid:731 }" data-act="cityChange-click">北碚</a>
                            <a class="js-city-name" data-ci="783" data-val="{ choosecityid:783 }" data-act="cityChange-click">宝丰</a>
                            <a class="js-city-name" data-ci="887" data-val="{ choosecityid:887 }" data-act="cityChange-click">泌阳</a>
                            <a class="js-city-name" data-ci="852" data-val="{ choosecityid:852 }" data-act="cityChange-click">博兴</a>
                            <a class="js-city-name" data-ci="952" data-val="{ choosecityid:952 }" data-act="cityChange-click">博山</a>
                            <a class="js-city-name" data-ci="946" data-val="{ choosecityid:946 }" data-act="cityChange-click">璧山</a>
                            <a class="js-city-name" data-ci="915" data-val="{ choosecityid:915 }" data-act="cityChange-click">彬县</a>
                            <a class="js-city-name" data-ci="994" data-val="{ choosecityid:994 }" data-act="cityChange-click">宾阳</a>
                            <a class="js-city-name" data-ci="1102" data-val="{ choosecityid:1102 }" data-act="cityChange-click">博白县</a>
                            <a class="js-city-name" data-ci="1098" data-val="{ choosecityid:1098 }" data-act="cityChange-click">博罗县</a>
                            <a class="js-city-name" data-ci="1141" data-val="{ choosecityid:1141 }" data-act="cityChange-click">北镇市</a>
                            <a class="js-city-name" data-ci="1074" data-val="{ choosecityid:1074 }" data-act="cityChange-click">泊头市</a>
                            <a class="js-city-name" data-ci="1165" data-val="{ choosecityid:1165 }" data-act="cityChange-click">北安市</a>
                            <a class="js-city-name" data-ci="1193" data-val="{ choosecityid:1193 }" data-act="cityChange-click">巴彦县</a>
                        </div>
                    </li>
                    <li>
                        <span>C</span>
                        <div>
                            <a class="js-city-name" data-ci="45" data-val="{ choosecityid:45 }" data-act="cityChange-click">重庆</a>
                            <a class="js-city-name" data-ci="59" data-val="{ choosecityid:59 }" data-act="cityChange-click">成都</a>
                            <a class="js-city-name" data-ci="70" data-val="{ choosecityid:70 }" data-act="cityChange-click">长沙</a>
                            <a class="js-city-name" data-ci="89" data-val="{ choosecityid:89 }" data-act="cityChange-click">常州</a>
                            <a class="js-city-name" data-ci="116" data-val="{ choosecityid:116 }" data-act="cityChange-click">长春</a>
                            <a class="js-city-name" data-ci="127" data-val="{ choosecityid:127 }" data-act="cityChange-click">沧州</a>
                            <a class="js-city-name" data-ci="126" data-val="{ choosecityid:126 }" data-act="cityChange-click">承德</a>
                            <a class="js-city-name" data-ci="142" data-val="{ choosecityid:142 }" data-act="cityChange-click">赤峰</a>
                            <a class="js-city-name" data-ci="131" data-val="{ choosecityid:131 }" data-act="cityChange-click">长治</a>
                            <a class="js-city-name" data-ci="160" data-val="{ choosecityid:160 }" data-act="cityChange-click">朝阳</a>
                            <a class="js-city-name" data-ci="205" data-val="{ choosecityid:205 }" data-act="cityChange-click">池州</a>
                            <a class="js-city-name" data-ci="202" data-val="{ choosecityid:202 }" data-act="cityChange-click">巢湖</a>
                            <a class="js-city-name" data-ci="199" data-val="{ choosecityid:199 }" data-act="cityChange-click">滁州</a>
                            <a class="js-city-name" data-ci="287" data-val="{ choosecityid:287 }" data-act="cityChange-click">潮州</a>
                            <a class="js-city-name" data-ci="271" data-val="{ choosecityid:271 }" data-act="cityChange-click">郴州</a>
                            <a class="js-city-name" data-ci="268" data-val="{ choosecityid:268 }" data-act="cityChange-click">常德</a>
                            <a class="js-city-name" data-ci="301" data-val="{ choosecityid:301 }" data-act="cityChange-click">崇左</a>
                            <a class="js-city-name" data-ci="337" data-val="{ choosecityid:337 }" data-act="cityChange-click">楚雄</a>
                            <a class="js-city-name" data-ci="391" data-val="{ choosecityid:391 }" data-act="cityChange-click">昌吉</a>
                            <a class="js-city-name" data-ci="421" data-val="{ choosecityid:421 }" data-act="cityChange-click">从化</a>
                            <a class="js-city-name" data-ci="422" data-val="{ choosecityid:422 }" data-act="cityChange-click">常熟</a>
                            <a class="js-city-name" data-ci="463" data-val="{ choosecityid:463 }" data-act="cityChange-click">长乐</a>
                            <a class="js-city-name" data-ci="452" data-val="{ choosecityid:452 }" data-act="cityChange-click">长兴</a>
                            <a class="js-city-name" data-ci="451" data-val="{ choosecityid:451 }" data-act="cityChange-click">慈溪</a>
                            <a class="js-city-name" data-ci="527" data-val="{ choosecityid:527 }" data-act="cityChange-click">昌邑</a>
                            <a class="js-city-name" data-ci="627" data-val="{ choosecityid:627 }" data-act="cityChange-click">长葛</a>
                            <a class="js-city-name" data-ci="624" data-val="{ choosecityid:624 }" data-act="cityChange-click">苍南</a>
                            <a class="js-city-name" data-ci="700" data-val="{ choosecityid:700 }" data-act="cityChange-click">承德县</a>
                            <a class="js-city-name" data-ci="653" data-val="{ choosecityid:653 }" data-act="cityChange-click">赤壁</a>
                            <a class="js-city-name" data-ci="646" data-val="{ choosecityid:646 }" data-act="cityChange-click">崇州</a>
                            <a class="js-city-name" data-ci="660" data-val="{ choosecityid:660 }" data-act="cityChange-click">淳安</a>
                            <a class="js-city-name" data-ci="746" data-val="{ choosecityid:746 }" data-act="cityChange-click">曹妃甸</a>
                            <a class="js-city-name" data-ci="737" data-val="{ choosecityid:737 }" data-act="cityChange-click">昌乐</a>
                            <a class="js-city-name" data-ci="767" data-val="{ choosecityid:767 }" data-act="cityChange-click">磁县</a>
                            <a class="js-city-name" data-ci="801" data-val="{ choosecityid:801 }" data-act="cityChange-click">昌黎</a>
                            <a class="js-city-name" data-ci="811" data-val="{ choosecityid:811 }" data-act="cityChange-click">岑溪</a>
                            <a class="js-city-name" data-ci="798" data-val="{ choosecityid:798 }" data-act="cityChange-click">成安</a>
                            <a class="js-city-name" data-ci="795" data-val="{ choosecityid:795 }" data-act="cityChange-click">长垣</a>
                            <a class="js-city-name" data-ci="883" data-val="{ choosecityid:883 }" data-act="cityChange-click">曹县</a>
                            <a class="js-city-name" data-ci="890" data-val="{ choosecityid:890 }" data-act="cityChange-click">城阳</a>
                            <a class="js-city-name" data-ci="877" data-val="{ choosecityid:877 }" data-act="cityChange-click">茌平</a>
                            <a class="js-city-name" data-ci="954" data-val="{ choosecityid:954 }" data-act="cityChange-click">长汀</a>
                            <a class="js-city-name" data-ci="909" data-val="{ choosecityid:909 }" data-act="cityChange-click">城固</a>
                            <a class="js-city-name" data-ci="1018" data-val="{ choosecityid:1018 }" data-act="cityChange-click">赤水</a>
                            <a class="js-city-name" data-ci="993" data-val="{ choosecityid:993 }" data-act="cityChange-click">常山</a>
                            <a class="js-city-name" data-ci="981" data-val="{ choosecityid:981 }" data-act="cityChange-click">长寿</a>
                            <a class="js-city-name" data-ci="970" data-val="{ choosecityid:970 }" data-act="cityChange-click">潮安</a>
                            <a class="js-city-name" data-ci="969" data-val="{ choosecityid:969 }" data-act="cityChange-click">潮阳</a>
                            <a class="js-city-name" data-ci="968" data-val="{ choosecityid:968 }" data-act="cityChange-click">澄海</a>
                            <a class="js-city-name" data-ci="1100" data-val="{ choosecityid:1100 }" data-act="cityChange-click">长丰县</a>
                            <a class="js-city-name" data-ci="1097" data-val="{ choosecityid:1097 }" data-act="cityChange-click">茶陵</a>
                            <a class="js-city-name" data-ci="1092" data-val="{ choosecityid:1092 }" data-act="cityChange-click">常宁市</a>
                            <a class="js-city-name" data-ci="1150" data-val="{ choosecityid:1150 }" data-act="cityChange-click">苍溪县</a>
                            <a class="js-city-name" data-ci="1078" data-val="{ choosecityid:1078 }" data-act="cityChange-click">慈利</a>
                            <a class="js-city-name" data-ci="1157" data-val="{ choosecityid:1157 }" data-act="cityChange-click">长清区</a>
                            <a class="js-city-name" data-ci="1164" data-val="{ choosecityid:1164 }" data-act="cityChange-click">崇明区</a>
                            <a class="js-city-name" data-ci="1201" data-val="{ choosecityid:1201 }" data-act="cityChange-click">成武县</a>
                            <a class="js-city-name" data-ci="1205" data-val="{ choosecityid:1205 }" data-act="cityChange-click">澄江县</a>
                        </div>
                    </li>
                    <li>
                        <span>D</span>
                        <div>
                            <a class="js-city-name" data-ci="65" data-val="{ choosecityid:65 }" data-act="cityChange-click">大连</a>
                            <a class="js-city-name" data-ci="91" data-val="{ choosecityid:91 }" data-act="cityChange-click">东莞</a>
                            <a class="js-city-name" data-ci="90" data-val="{ choosecityid:90 }" data-act="cityChange-click">大庆</a>
                            <a class="js-city-name" data-ci="129" data-val="{ choosecityid:129 }" data-act="cityChange-click">大同</a>
                            <a class="js-city-name" data-ci="154" data-val="{ choosecityid:154 }" data-act="cityChange-click">丹东</a>
                            <a class="js-city-name" data-ci="178" data-val="{ choosecityid:178 }" data-act="cityChange-click">大兴安岭</a>
                            <a class="js-city-name" data-ci="223" data-val="{ choosecityid:223 }" data-act="cityChange-click">东营</a>
                            <a class="js-city-name" data-ci="231" data-val="{ choosecityid:231 }" data-act="cityChange-click">德州</a>
                            <a class="js-city-name" data-ci="305" data-val="{ choosecityid:305 }" data-act="cityChange-click">德阳</a>
                            <a class="js-city-name" data-ci="315" data-val="{ choosecityid:315 }" data-act="cityChange-click">达州</a>
                            <a class="js-city-name" data-ci="342" data-val="{ choosecityid:342 }" data-act="cityChange-click">德宏</a>
                            <a class="js-city-name" data-ci="341" data-val="{ choosecityid:341 }" data-act="cityChange-click">大理</a>
                            <a class="js-city-name" data-ci="344" data-val="{ choosecityid:344 }" data-act="cityChange-click">迪庆</a>
                            <a class="js-city-name" data-ci="370" data-val="{ choosecityid:370 }" data-act="cityChange-click">定西</a>
                            <a class="js-city-name" data-ci="434" data-val="{ choosecityid:434 }" data-act="cityChange-click">敦煌</a>
                            <a class="js-city-name" data-ci="431" data-val="{ choosecityid:431 }" data-act="cityChange-click">丹阳</a>
                            <a class="js-city-name" data-ci="478" data-val="{ choosecityid:478 }" data-act="cityChange-click">东台</a>
                            <a class="js-city-name" data-ci="477" data-val="{ choosecityid:477 }" data-act="cityChange-click">大丰</a>
                            <a class="js-city-name" data-ci="467" data-val="{ choosecityid:467 }" data-act="cityChange-click">德清</a>
                            <a class="js-city-name" data-ci="455" data-val="{ choosecityid:455 }" data-act="cityChange-click">东阳</a>
                            <a class="js-city-name" data-ci="491" data-val="{ choosecityid:491 }" data-act="cityChange-click">当阳</a>
                            <a class="js-city-name" data-ci="552" data-val="{ choosecityid:552 }" data-act="cityChange-click">登封</a>
                            <a class="js-city-name" data-ci="571" data-val="{ choosecityid:571 }" data-act="cityChange-click">儋州</a>
                            <a class="js-city-name" data-ci="539" data-val="{ choosecityid:539 }" data-act="cityChange-click">东港</a>
                            <a class="js-city-name" data-ci="635" data-val="{ choosecityid:635 }" data-act="cityChange-click">东兴</a>
                            <a class="js-city-name" data-ci="576" data-val="{ choosecityid:576 }" data-act="cityChange-click">都江堰</a>
                            <a class="js-city-name" data-ci="599" data-val="{ choosecityid:599 }" data-act="cityChange-click">大石桥</a>
                            <a class="js-city-name" data-ci="600" data-val="{ choosecityid:600 }" data-act="cityChange-click">大冶</a>
                            <a class="js-city-name" data-ci="686" data-val="{ choosecityid:686 }" data-act="cityChange-click">东方</a>
                            <a class="js-city-name" data-ci="679" data-val="{ choosecityid:679 }" data-act="cityChange-click">大通</a>
                            <a class="js-city-name" data-ci="651" data-val="{ choosecityid:651 }" data-act="cityChange-click">灯塔</a>
                            <a class="js-city-name" data-ci="642" data-val="{ choosecityid:642 }" data-act="cityChange-click">调兵山</a>
                            <a class="js-city-name" data-ci="662" data-val="{ choosecityid:662 }" data-act="cityChange-click">邓州</a>
                            <a class="js-city-name" data-ci="750" data-val="{ choosecityid:750 }" data-act="cityChange-click">电白</a>
                            <a class="js-city-name" data-ci="738" data-val="{ choosecityid:738 }" data-act="cityChange-click">东平</a>
                            <a class="js-city-name" data-ci="765" data-val="{ choosecityid:765 }" data-act="cityChange-click">定州</a>
                            <a class="js-city-name" data-ci="754" data-val="{ choosecityid:754 }" data-act="cityChange-click">东海</a>
                            <a class="js-city-name" data-ci="874" data-val="{ choosecityid:874 }" data-act="cityChange-click">达拉特旗</a>
                            <a class="js-city-name" data-ci="835" data-val="{ choosecityid:835 }" data-act="cityChange-click">郸城</a>
                            <a class="js-city-name" data-ci="836" data-val="{ choosecityid:836 }" data-act="cityChange-click">大荔</a>
                            <a class="js-city-name" data-ci="945" data-val="{ choosecityid:945 }" data-act="cityChange-click">大洼</a>
                            <a class="js-city-name" data-ci="910" data-val="{ choosecityid:910 }" data-act="cityChange-click">大竹</a>
                            <a class="js-city-name" data-ci="999" data-val="{ choosecityid:999 }" data-act="cityChange-click">东光</a>
                            <a class="js-city-name" data-ci="978" data-val="{ choosecityid:978 }" data-act="cityChange-click">敦化</a>
                            <a class="js-city-name" data-ci="971" data-val="{ choosecityid:971 }" data-act="cityChange-click">大邑</a>
                            <a class="js-city-name" data-ci="974" data-val="{ choosecityid:974 }" data-act="cityChange-click">砀山</a>
                            <a class="js-city-name" data-ci="1035" data-val="{ choosecityid:1035 }" data-act="cityChange-click">道县</a>
                            <a class="js-city-name" data-ci="1076" data-val="{ choosecityid:1076 }" data-act="cityChange-click">大安市</a>
                            <a class="js-city-name" data-ci="1168" data-val="{ choosecityid:1168 }" data-act="cityChange-click">定安县</a>
                            <a class="js-city-name" data-ci="1203" data-val="{ choosecityid:1203 }" data-act="cityChange-click">东明县</a>
                            <a class="js-city-name" data-ci="1204" data-val="{ choosecityid:1204 }" data-act="cityChange-click">定陶区</a>
                            <a class="js-city-name" data-ci="1208" data-val="{ choosecityid:1208 }" data-act="cityChange-click">定边县</a>
                        </div>
                    </li>
                    <li>
                        <span>E</span>
                        <div>
                            <a class="js-city-name" data-ci="144" data-val="{ choosecityid:144 }" data-act="cityChange-click">鄂尔多斯</a>
                            <a class="js-city-name" data-ci="254" data-val="{ choosecityid:254 }" data-act="cityChange-click">鄂州</a>
                            <a class="js-city-name" data-ci="261" data-val="{ choosecityid:261 }" data-act="cityChange-click">恩施</a>
                            <a class="js-city-name" data-ci="417" data-val="{ choosecityid:417 }" data-act="cityChange-click">峨眉山</a>
                            <a class="js-city-name" data-ci="568" data-val="{ choosecityid:568 }" data-act="cityChange-click">额尔古纳</a>
                            <a class="js-city-name" data-ci="989" data-val="{ choosecityid:989 }" data-act="cityChange-click">恩平</a>
                            <a class="js-city-name" data-ci="1172" data-val="{ choosecityid:1172 }" data-act="cityChange-click">额敏县</a>
                        </div>
                    </li>
                    <li>
                        <span>F</span>
                        <div>
                            <a class="js-city-name" data-ci="44" data-val="{ choosecityid:44 }" data-act="cityChange-click">福州</a>
                            <a class="js-city-name" data-ci="92" data-val="{ choosecityid:92 }" data-act="cityChange-click">佛山</a>
                            <a class="js-city-name" data-ci="152" data-val="{ choosecityid:152 }" data-act="cityChange-click">抚顺</a>
                            <a class="js-city-name" data-ci="156" data-val="{ choosecityid:156 }" data-act="cityChange-click">阜新</a>
                            <a class="js-city-name" data-ci="200" data-val="{ choosecityid:200 }" data-act="cityChange-click">阜阳</a>
                            <a class="js-city-name" data-ci="220" data-val="{ choosecityid:220 }" data-act="cityChange-click">抚州</a>
                            <a class="js-city-name" data-ci="293" data-val="{ choosecityid:293 }" data-act="cityChange-click">防城港</a>
                            <a class="js-city-name" data-ci="427" data-val="{ choosecityid:427 }" data-act="cityChange-click">涪陵</a>
                            <a class="js-city-name" data-ci="416" data-val="{ choosecityid:416 }" data-act="cityChange-click">富阳</a>
                            <a class="js-city-name" data-ci="462" data-val="{ choosecityid:462 }" data-act="cityChange-click">福清</a>
                            <a class="js-city-name" data-ci="480" data-val="{ choosecityid:480 }" data-act="cityChange-click">凤凰</a>
                            <a class="js-city-name" data-ci="545" data-val="{ choosecityid:545 }" data-act="cityChange-click">肥城</a>
                            <a class="js-city-name" data-ci="535" data-val="{ choosecityid:535 }" data-act="cityChange-click">阜宁</a>
                            <a class="js-city-name" data-ci="540" data-val="{ choosecityid:540 }" data-act="cityChange-click">奉化</a>
                            <a class="js-city-name" data-ci="677" data-val="{ choosecityid:677 }" data-act="cityChange-click">汾阳</a>
                            <a class="js-city-name" data-ci="689" data-val="{ choosecityid:689 }" data-act="cityChange-click">阜康</a>
                            <a class="js-city-name" data-ci="665" data-val="{ choosecityid:665 }" data-act="cityChange-click">凤城</a>
                            <a class="js-city-name" data-ci="742" data-val="{ choosecityid:742 }" data-act="cityChange-click">范县</a>
                            <a class="js-city-name" data-ci="735" data-val="{ choosecityid:735 }" data-act="cityChange-click">丰城</a>
                            <a class="js-city-name" data-ci="827" data-val="{ choosecityid:827 }" data-act="cityChange-click">封丘</a>
                            <a class="js-city-name" data-ci="792" data-val="{ choosecityid:792 }" data-act="cityChange-click">肥乡</a>
                            <a class="js-city-name" data-ci="774" data-val="{ choosecityid:774 }" data-act="cityChange-click">繁昌</a>
                            <a class="js-city-name" data-ci="888" data-val="{ choosecityid:888 }" data-act="cityChange-click">富顺</a>
                            <a class="js-city-name" data-ci="869" data-val="{ choosecityid:869 }" data-act="cityChange-click">抚松</a>
                            <a class="js-city-name" data-ci="862" data-val="{ choosecityid:862 }" data-act="cityChange-click">丰县</a>
                            <a class="js-city-name" data-ci="861" data-val="{ choosecityid:861 }" data-act="cityChange-click">扶风</a>
                            <a class="js-city-name" data-ci="937" data-val="{ choosecityid:937 }" data-act="cityChange-click">扶沟</a>
                            <a class="js-city-name" data-ci="924" data-val="{ choosecityid:924 }" data-act="cityChange-click">丰宁</a>
                            <a class="js-city-name" data-ci="921" data-val="{ choosecityid:921 }" data-act="cityChange-click">佛冈</a>
                            <a class="js-city-name" data-ci="916" data-val="{ choosecityid:916 }" data-act="cityChange-click">费县</a>
                            <a class="js-city-name" data-ci="980" data-val="{ choosecityid:980 }" data-act="cityChange-click">凤台</a>
                            <a class="js-city-name" data-ci="1142" data-val="{ choosecityid:1142 }" data-act="cityChange-click">肥西县</a>
                            <a class="js-city-name" data-ci="1031" data-val="{ choosecityid:1031 }" data-act="cityChange-click">奉新</a>
                            <a class="js-city-name" data-ci="1052" data-val="{ choosecityid:1052 }" data-act="cityChange-click">方城</a>
                            <a class="js-city-name" data-ci="1066" data-val="{ choosecityid:1066 }" data-act="cityChange-click">富源县</a>
                            <a class="js-city-name" data-ci="1070" data-val="{ choosecityid:1070 }" data-act="cityChange-click">分宜</a>
                            <a class="js-city-name" data-ci="1084" data-val="{ choosecityid:1084 }" data-act="cityChange-click">扶绥县</a>
                            <a class="js-city-name" data-ci="1152" data-val="{ choosecityid:1152 }" data-act="cityChange-click">凤翔县</a>
                            <a class="js-city-name" data-ci="1195" data-val="{ choosecityid:1195 }" data-act="cityChange-click">福安</a>
                            <a class="js-city-name" data-ci="1202" data-val="{ choosecityid:1202 }" data-act="cityChange-click">福鼎市</a>
                            <a class="js-city-name" data-ci="1209" data-val="{ choosecityid:1209 }" data-act="cityChange-click">府谷县</a>
                        </div>
                    </li>
                    <li>
                        <span>G</span>
                        <div>
                            ...
                            <a class="js-city-name" data-ci="314" data-val="{ choosecityid:314 }" data-act="cityChange-click">广安</a>
                            <a class="js-city-name" data-ci="295" data-val="{ choosecityid:295 }" data-act="cityChange-click">贵港</a>
                            <a class="js-city-name" data-ci="320" data-val="{ choosecityid:320 }" data-act="cityChange-click">甘孜</a>
                            <a class="js-city-name" data-ci="373" data-val="{ choosecityid:373 }" data-act="cityChange-click">甘南</a>
                            <a class="js-city-name" data-ci="385" data-val="{ choosecityid:385 }" data-act="cityChange-click">固原</a>
                            <a class="js-city-name" data-ci="553" data-val="{ choosecityid:553 }" data-act="cityChange-click">巩义</a>
                            <a class="js-city-name" data-ci="570" data-val="{ choosecityid:570 }" data-act="cityChange-click">桂平</a>
                            <a class="js-city-name" data-ci="521" data-val="{ choosecityid:521 }" data-act="cityChange-click">高邮</a>
                            <a class="js-city-name" data-ci="541" data-val="{ choosecityid:541 }" data-act="cityChange-click">广饶</a>
                            <a class="js-city-name" data-ci="631" data-val="{ choosecityid:631 }" data-act="cityChange-click">高州</a>
                            <a class="js-city-name" data-ci="630" data-val="{ choosecityid:630 }" data-act="cityChange-click">个旧</a>
                            <a class="js-city-name" data-ci="629" data-val="{ choosecityid:629 }" data-act="cityChange-click">高碑店</a>
                            <a class="js-city-name" data-ci="638" data-val="{ choosecityid:638 }" data-act="cityChange-click">盖州</a>
                            <a class="js-city-name" data-ci="581" data-val="{ choosecityid:581 }" data-act="cityChange-click">公主岭</a>
                            <a class="js-city-name" data-ci="589" data-val="{ choosecityid:589 }" data-act="cityChange-click">高密</a>
                            <a class="js-city-name" data-ci="593" data-val="{ choosecityid:593 }" data-act="cityChange-click">广汉</a>
                            <a class="js-city-name" data-ci="595" data-val="{ choosecityid:595 }" data-act="cityChange-click">藁城</a>
                            <a class="js-city-name" data-ci="601" data-val="{ choosecityid:601 }" data-act="cityChange-click">高平</a>
                            <a class="js-city-name" data-ci="702" data-val="{ choosecityid:702 }" data-act="cityChange-click">格尔木</a>
                            <a class="js-city-name" data-ci="691" data-val="{ choosecityid:691 }" data-act="cityChange-click">古交</a>
                            <a class="js-city-name" data-ci="751" data-val="{ choosecityid:751 }" data-act="cityChange-click">灌云</a>
                            <a class="js-city-name" data-ci="752" data-val="{ choosecityid:752 }" data-act="cityChange-click">灌南</a>
                            <a class="js-city-name" data-ci="753" data-val="{ choosecityid:753 }" data-act="cityChange-click">赣榆</a>
                            <a class="js-city-name" data-ci="787" data-val="{ choosecityid:787 }" data-act="cityChange-click">共青城</a>
                            <a class="js-city-name" data-ci="771" data-val="{ choosecityid:771 }" data-act="cityChange-click">高安</a>
                            <a class="js-city-name" data-ci="780" data-val="{ choosecityid:780 }" data-act="cityChange-click">广德</a>
                            <a class="js-city-name" data-ci="866" data-val="{ choosecityid:866 }" data-act="cityChange-click">高陵</a>
                            <a class="js-city-name" data-ci="854" data-val="{ choosecityid:854 }" data-act="cityChange-click">高阳</a>
                            <a class="js-city-name" data-ci="911" data-val="{ choosecityid:911 }" data-act="cityChange-click">公安</a>
                            <a class="js-city-name" data-ci="1104" data-val="{ choosecityid:1104 }" data-act="cityChange-click">固始县</a>
                            <a class="js-city-name" data-ci="1174" data-val="{ choosecityid:1174 }" data-act="cityChange-click">光泽</a>
                        </div>
                    </li>
                    <li>
                        <span>H</span>
                        <div>
                            <a class="js-city-name" data-ci="50" data-val="{ choosecityid:50 }" data-act="cityChange-click">杭州</a>
                            <a class="js-city-name" data-ci="56" data-val="{ choosecityid:56 }" data-act="cityChange-click">合肥</a>
                            <a class="js-city-name" data-ci="95" data-val="{ choosecityid:95 }" data-act="cityChange-click">葫芦岛</a>
                            <a class="js-city-name" data-ci="94" data-val="{ choosecityid:94 }" data-act="cityChange-click">海口</a>
                            <a class="js-city-name" data-ci="105" data-val="{ choosecityid:105 }" data-act="cityChange-click">哈尔滨</a>
                            <a class="js-city-name" data-ci="123" data-val="{ choosecityid:123 }" data-act="cityChange-click">邯郸</a>
                            <a class="js-city-name" data-ci="139" data-val="{ choosecityid:139 }" data-act="cityChange-click">呼和浩特</a>
                            <a class="js-city-name" data-ci="128" data-val="{ choosecityid:128 }" data-act="cityChange-click">衡水</a>
                            <a class="js-city-name" data-ci="145" data-val="{ choosecityid:145 }" data-act="cityChange-click">呼伦贝尔</a>
                            <a class="js-city-name" data-ci="170" data-val="{ choosecityid:170 }" data-act="cityChange-click">鹤岗</a>
                            <a class="js-city-name" data-ci="186" data-val="{ choosecityid:186 }" data-act="cityChange-click">湖州</a>
                            <a class="js-city-name" data-ci="176" data-val="{ choosecityid:176 }" data-act="cityChange-click">黑河</a>
                            <a class="js-city-name" data-ci="180" data-val="{ choosecityid:180 }" data-act="cityChange-click">淮安</a>
                            <a class="js-city-name" data-ci="198" data-val="{ choosecityid:198 }" data-act="cityChange-click">黄山</a>
                            <a class="js-city-name" data-ci="193" data-val="{ choosecityid:193 }" data-act="cityChange-click">淮南</a>
                            <a class="js-city-name" data-ci="195" data-val="{ choosecityid:195 }" data-act="cityChange-click">淮北</a>
                            <a class="js-city-name" data-ci="239" data-val="{ choosecityid:239 }" data-act="cityChange-click">鹤壁</a>
                            <a class="js-city-name" data-ci="234" data-val="{ choosecityid:234 }" data-act="cityChange-click">菏泽</a>
                            <a class="js-city-name" data-ci="250" data-val="{ choosecityid:250 }" data-act="cityChange-click">黄石</a>
                            <a class="js-city-name" data-ci="273" data-val="{ choosecityid:273 }" data-act="cityChange-click">怀化</a>
                            <a class="js-city-name" data-ci="281" data-val="{ choosecityid:281 }" data-act="cityChange-click">惠州</a>
                            <a class="js-city-name" data-ci="284" data-val="{ choosecityid:284 }" data-act="cityChange-click">河源</a>
                            <a class="js-city-name" data-ci="258" data-val="{ choosecityid:258 }" data-act="cityChange-click">黄冈</a>
                            <a class="js-city-name" data-ci="265" data-val="{ choosecityid:265 }" data-act="cityChange-click">衡阳</a>
                            <a class="js-city-name" data-ci="298" data-val="{ choosecityid:298 }" data-act="cityChange-click">贺州</a>
                            <a class="js-city-name" data-ci="299" data-val="{ choosecityid:299 }" data-act="cityChange-click">河池</a>
                            <a class="js-city-name" data-ci="338" data-val="{ choosecityid:338 }" data-act="cityChange-click">红河</a>
                            <a class="js-city-name" data-ci="375" data-val="{ choosecityid:375 }" data-act="cityChange-click">海东</a>
                            <a class="js-city-name" data-ci="381" data-val="{ choosecityid:381 }" data-act="cityChange-click">海西</a>
                            <a class="js-city-name" data-ci="378" data-val="{ choosecityid:378 }" data-act="cityChange-click">海南州</a>
                            <a class="js-city-name" data-ci="357" data-val="{ choosecityid:357 }" data-act="cityChange-click">汉中</a>
                            <a class="js-city-name" data-ci="
                                410" data-val="{ choosecityid:410 }" data-act="cityChange-click">花都</a>
                            <a class="js-city-name" data-ci="390" data-val="{ choosecityid:390 }" data-act="cityChange-click">哈密</a>
                            <a class="js-city-name" data-ci="424" data-val="{ choosecityid:424 }" data-act="cityChange-click">海宁</a>
                            <a class="js-city-name" data-ci="472" data-val="{ choosecityid:472 }" data-act="cityChange-click">惠阳</a>
                            <a class="js-city-name" data-ci="471" data-val="{ choosecityid:471 }" data-act="cityChange-click">惠东</a>
                            <a class="js-city-name" data-ci="464" data-val="{ choosecityid:464 }" data-act="cityChange-click">黄岛</a>
                            <a class="js-city-name" data-ci="504" data-val="{ choosecityid:504 }" data-act="cityChange-click">鹤山</a>
                            <a class="js-city-name" data-ci="505" data-val="{ choosecityid:505 }" data-act="cityChange-click">桦甸</a>
                            <a class="js-city-name" data-ci="506" data-val="{ choosecityid:506 }" data-act="cityChange-click">海城</a>
                            <a class="js-city-name" data-ci="564" data-val="{ choosecityid:564 }" data-act="cityChange-click">华阴</a>
                            <a class="js-city-name" data-ci="575" data-val="{ choosecityid:575 }" data-act="cityChange-click">霸州</a>
                            <a class="js-city-name" data-ci="573" data-val="{ choosecityid:573 }" data-act="cityChange-click">海阳</a>
                            <a class="js-city-name" data-ci="519" data-val="{ choosecityid:519 }" data-act="cityChange-click">海门</a>
                            <a class="js-city-name" data-ci="623" data-val="{ choosecityid:623 }" data-act="cityChange-click">海安</a>
                            <a class="js-city-name" data-ci="579" data-val="{ choosecityid:579 }" data-act="cityChange-click">侯马</a>
                            <a class="js-city-name" data-ci="598" data-val="{ choosecityid:598 }" data-act="cityChange-click">河津</a>
                            <a class="js-city-name" data-ci="685" data-val="{ choosecityid:685 }" data-act="cityChange-click">海林</a>
                            <a class="js-city-name" data-ci="672" data-val="{ choosecityid:672 }" data-act="cityChange-click">化州</a>
                            <a class="js-city-name" data-ci="650" data-val="{ choosecityid:650 }" data-act="cityChange-click">黄骅</a>
                            <a class="js-city-name" data-ci="645" data-val="{ choosecityid:645 }" data-act="cityChange-click">霍州</a>
                            <a class="js-city-name" data-ci="758" data-val="{ choosecityid:758 }" data-act="cityChange-click">淮阳</a>
                            <a class="js-city-name" data-ci="732" data-val="{ choosecityid:732 }" data-act="cityChange-click">合川</a>
                            <a class="js-city-name" data-ci="726" data-val="{ choosecityid:726 }" data-act="cityChange-click">海盐</a>
                            <a class="js-city-name" data-ci="816" data-val="{ choosecityid:816 }" data-act="cityChange-click">滑县</a>
                            <a class="js-city-name" data-ci="825" data-val="{ choosecityid:825 }" data-act="cityChange-click">惠安</a>
                            <a class="js-city-name" data-ci="806" data-val="{ choosecityid:806 }" data-act="cityChange-click">怀仁</a>
                            <a class="js-city-name" data-ci="800" data-val="{ choosecityid:800 }" data-act="cityChange-click">辉县</a>
                            <a class="js-city-name" data-ci="799" data-val="{ choosecityid:799 }" data-act="cityChange-click">户县</a>
                            <a class="js-city-name" data-ci="794" data-val="{ choosecityid:794 }" data-act="cityChange-click">和县</a>
                            <a class="js-city-name" data-ci="793" data-val="{ choosecityid:793 }" data-act="cityChange-click">含山</a>
                            <a class="js-city-name" data-ci="772" data-val="{ choosecityid:772 }" data-act="cityChange-click">汉阴</a>
                            <a class="js-city-name" data-ci="881" data-val="{ choosecityid:881 }" data-act="cityChange-click">河口</a>
                            <a class="js-city-name" data-ci="894" data-val="{ choosecityid:894 }" data-act="cityChange-click">辉南</a>
                            <a class="js-city-name" data-ci="867" data-val="{ choosecityid:867 }" data-act="cityChange-click">洪洞</a>
