...
.city-container:hover .city-list{
    display: block;
    ...
    <div class="header-inner">
        ...
        <div class="city-container">
            <div class="city-selected">
                <div class="city-name">南沙
                    <span class="caret"></span>
                </div>
            </div>
            <div class="city-list">
                <div class="city-list-header">定位城市：<a class="js-geo-city">南沙</a></div>
                <ul>
                    <li>
                        <span>A</span>
                        <div>
        ...
        <div class="nav">
            <ul class="nav-bar">
                ...
                <li class="bar"><a href="${pageContext.request.contextPath }">电影</a></li>
                <li class="bar"><a href="${pageContext.request.contextPath }">影院</a></li>
                <li class="bar"><a href="${pageContext.request.contextPath }">榜单</a></li>
        ...
        <input class="search" id="keyword" type="text" placeholder="找电视剧、影人、影院" onkeyup="getMoreContents()" onblur="keywordBlur()" onfocus="getMoreContents()"/>                               		
        <div class='suggest-container'>     
			<div class='suggest-body'>
			<span class='suggest-name'></span>
			<div id='suggest-detail-list'></div>
			</div>
		</div>
        <input class="submit" type="submit" value=""/>
        
		</form>
        <div class="app-download" onmouseover="downdis()" onmouseout="downdisn()">
...
<script>
function downdis(){
    var d= document.getElementById("download-icon");
    d.style.display="block";
    d.style.borderTop="1px solid transparent"
}
function downdisn(){
    var d= document.getElementById("download-icon");
...
function iconcss(){
    var i = document.getElementsByClassName("caret");
    i.style.transform.rotate(90);
}
function citydis(){
    var c = document.getElementById("city-list");
    var cc = document.getElementById("city-container");
    c.style.display = "block";
    c.style.borderTop="none";
    cc.style.borderLeft="1px solid #e5e5e5";
    cc.style.borderRight="1px solid #e5e5e5";
}
function citydisn(){
    var c = document.getElementById("city-list");
...
function usermenudis(){
    ...
    u.style.borderTop="1px solid transparent";
}
function usermenudisn(){
...
function getMoreContents(){
	...
	if(content == ""){
		//当输入框为空时，清空之前的数据
		document.getElementsByClassName("suggest-container")[0].style.display="none";
		clearContent();
		return;
	}
	document.getElementsByClassName("suggest-container")[0].style.display="block";
	//alert(content.value);
	...
	var url = "${pageContext.request.contextPath}/search?keyword="+content;
...
function setContent(contents){
	...
	for(var i =0;i < size;i++){
		...
		a.className = "suggest-detail";
		img.className = "detail-img";
		span.className = "detail-name";
		img.src="http://p1.meituan.net/movie/f9e3e277d182ac4330eb10af630f536c1491832.jpg@36w_50h_1e_1c";
		var text = document.createTextNode(nextNode);
		span.appendChild(text);
		a.appendChild(img);
		a.appendChild(span);
		document.getElementById("suggest-detail-list").appendChild(a);				
	...
	function clearContent(){
		var contentTableBody = document.getElementById("suggest-detail-list");
