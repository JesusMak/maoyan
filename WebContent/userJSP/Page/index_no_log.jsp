...
<head lang="en">
    ...
    <link href="${pageContext.request.contextPath }/userJSP/CSS/index.css" rel="stylesheet" type="text/css">
    <script src="${pageContext.request.contextPath }/userJSP/JS/jquery-3.3.1.min.js" charset="utf-8"></script>
    <script src="${pageContext.request.contextPath }/userJSP/JS/index.js" ></script>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/userJSP/CSS/font/iconfont.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/userJSP/CSS/font-awesome/css/font-awesome.min.css">
    <style>
...
<div class="container">
    ...
    <div class="head">
        <div  id="nav" class="nav">
            <img src="${pageContext.request.contextPath }/userJSP/img/logo.png">
            <div class="loc">地址
            ...
            <div class="download">
                <div id="app">
                    <img src="${pageContext.request.contextPath }/userJSP/img/app.png">
                    <div>
                        <span>扫码下载APP</span>
                        <span>选座更优惠</span>
                    </div>
                </div>
                <img src="${pageContext.request.contextPath }/userJSP/img/phone.png">APP下载
                <!--三角形-->
                <div class="triangle"></div>
            </div>
            <!--搜索框-->
            ...
            <div class="header">
                ...
                <img src="${pageContext.request.contextPath }/userJSP/img/header.png">
                <div class="triangle"></div>
            </div>
        </div>
    </div>
    ...
    <div id="round" class="round">
        <img src="${pageContext.request.contextPath }/userJSP/img/pic-1.jpg" class="pic">
        <img src="${pageContext.request.contextPath }/userJSP/img/pic-2.jpg" class="pic" style="display:none">
        <img src="${pageContext.request.contextPath }/userJSP/img/pic-3.jpg" class="pic" style="display:none">
        <img src="${pageContext.request.contextPath }/userJSP/img/pic-2.jpg" class="pic" style="display:none">
    ...
    <!--正在热映-->
        ...
        <div class="main-left">
            ...
            <div class="show-box">
                ...
                <div class="hot-movie">
                    <img src="${pageContext.request.contextPath }/userJSP/img/蚁人.jpg">
                    <p>${movie.movieName }</p>
        ...
        <div class="main-right">
            ...
            <div class="ranking-list">
                ...
                <div class="ranking">
                    ...
                    <img src="${pageContext.request.contextPath }/userJSP/img/first.jpg">
                    <span>爱情公寓</span><br>
                    <span>9641.13万</span>
                </div>
                <ul>
            ...
            <div class="ranking-list">
                ...
                <div class="ranking popular">
                    <i class="iconfont icon-menu-rank"></i>
                    <img src="${pageContext.request.contextPath }/userJSP/img/碟中谍6：全面瓦解.jpg">
                ...
                <div class="popular2">
                    <div>
                        <div class="num">2</div>
                        <img src="${pageContext.request.contextPath }/userJSP/img/反贪风暴3.jpg">
                        <span>反贪风暴3</span>
                        <span>123123想看</span>
                    </div>
                    <div>
                        <div class="num">3</div>
                        <img src="${pageContext.request.contextPath }/userJSP/img/阿尔法：狼伴归途.jpg">
                        <span>阿尔法：狼伴归途</span>
                        <span>123123想看</span>
                    </div>
                </div>
