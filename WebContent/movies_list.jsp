...
<base href="<%=basePath%>">
    ...
    <link type="text/css" href="css/movies_list_css.css" rel="stylesheet">
    <script src="js/maoyanjs.js" type="application/javascript"></script>
    <script src="js/JQuery3.3.1.js" type="application/javascript"></script>
    <script src="/js/movies_list.js" type="application/javascript"></script>
    ...
    <div class="wrapper clearfix">
        <div class="celeInfo-left">
            <div class="avatar-shadow">
                <img class="avatar" src="images/eed97cfe2718d28d688615830856d07b226733.jpg" alt="">
                <div class="movie-ver"><i class="m3d"></i></div>
            </div>
        </div>
        <div class="celeInfo-right clearfix">
            <div class="movie-brief-container">
                <h3 class="name">爵迹2</h3>
                <div class="ename ellipsis">L.O.R.D</div>
                <ul>
                    <li class="ellipsis">动画,奇幻</li>

                   <li class="ellipsis">中国大陆/120分</li>
                   <li class="ellipsis">2018大陆上映</li>
                </ul>
            </div>
            <div class="action-buyBtn">
                <div class="action clearfix" data-val="{movieid:344450}">
    ...
    <div class="main-content-container clearfix">
                    ...
                    <div class="tab-desc tab-content active">
                        ...
                        <div class="module">
                            ...
                            <div class="mod-content">
                                <span class="dra">为了完成前六度王爵西流尔的遗愿，鬼山莲泉、银尘、麒零、天束幽花四人决定一起前往，解救被白银祭司封印的前一度王爵吉尔伽美什。而当四人克服重重阻碍赶到囚禁之地，却不幸遇上白银祭司派出的最强杀手阵容：幽冥、特蕾娅、漆拉，一场正面交锋在所难免，整个亚斯蓝帝国最阴暗的秘密也将逐渐浮出水面。</span>
                                ...
                                <div class="celebrity-container clearfix">
                                    ...
                                    <div class="celebrity-group">
                                        ...
                                        <ul class="celebrity-list clearfix">
                                            <li class="celebrity " data-act="celebrity-click" data-val="{celebrityid:28061}">
                                                <a href="/films/celebrity/28061" target="_blank" class="portrait">
                                                    <img class="default-img" alt="" src="images/e4210cd8da1926263c4551346f0e5a7332093.jpg">
                                                </a>
                                                <div class="info">
                                                    <a href="/films/celebrity/28061" target="_blank" class="name">
                                                        郭敬明
                                                    </a>
                                                </div>
                                            </li>
                                    ...
                                    <div class="celebrity-group">
                                        ...
                                        <ul class="celebrity-list clearfix">
                                            <li class="celebrity actor" data-act="celebrity-click" data-val="{celebrityid:28233}">
                                                <a href="/films/celebrity/28233" target="_blank" class="portrait">
                                                    <img class="default-img" alt="" src="images/91fb1d24f1c3ac73da51b5649313a6e947317.jpg">
                                                </a>
                                                <div class="info">
                                                    <a href="/films/celebrity/28233" target="_blank" class="name">
                                                        范冰冰
                                                    </a>
                                                    <br><span class="role">饰：鬼山莲泉</span>
                                                </div>
                                            </li>

                                            <li class="celebrity actor" data-act="celebrity-click" data-val="{celebrityid:354023}">
                                                <a href="/films/celebrity/354023" target="_blank" class="portrait">
                                                    <img class="default-img" alt="" src="images/2fffff13ab6cefbcca5a6308281308be138672.jpg">
                                                </a>
                                                <div class="info">
                                                    <a href="/films/celebrity/354023" target="_blank" class="name">
                                                        吴亦凡
                                                    </a>
                                                    <br><span class="role">饰：银尘</span>
                                                </div>
                                            </li>

                                            <li class="celebrity actor" data-act="celebrity-click" data-val="{celebrityid:28068}">
                                                <a href="/films/celebrity/28068" target="_blank" class="portrait">
                                                    <img class="default-img" alt="" src="images/54878df5952297c147ecbc3a5e8d9ce531947.jpg">
                                                </a>
                                                <div class="info">
                                                    <a href="/films/celebrity/28068" target="_blank" class="name">
                                                        陈学冬
                                                    </a>
                                                    <br><span class="role">饰：麒零</span>
                                                </div>
                                            </li>

                                            <li class="celebrity actor" data-act="celebrity-click" data-val="{celebrityid:2749}">
                                                <a href="/films/celebrity/2749" target="_blank" class="portrait">
                                                    <img class="default-img" alt="" src="images/ecfdbe6286e4a27448e0c35d7fcaaecb125507.jpg">
                                                </a>
                                                <div class="info">
                                                    <a href="/films/celebrity/2749" target="_blank" class="name">
                                                        陈伟霆
                                                    </a>
                                                    <br><span class="role">饰：幽冥</span>
                                                </div>
                                            </li>
                        ...
                        <div class="module">
                            ...
                            <div class="mod-content">
                                <div class="album clearfix" data-act="movie-img-click">
                                    <div class="img1"><img class="default-img" alt="" src="images/5273d0705956b5d55679abbcd25a1288362014.jpg"></div>
                                    <div class="img2"><img class="default-img" alt="" src="images/6be7c551316dce66c49ec93944b96ebc395035.jpg"></div>
                                    <div class="img3"><img class="default-img" alt="" src="images/78afa08c4e9815de0ed0a3d07d4f35c8362067.jpg"></div>
                                    <div class="img4"><img class="default-img" alt="" src="images/969d8a93a8ca091e8e57f956c53b1669376171.jpg"></div>
                                    <div class="img5"><img class="default-img" alt="" src="images/bbace0f105778b0fdffb927487f54809353993.jpg"></div>
                                </div>
                            ...
                            <div class="mod-content">
                                <div class="comment-list-container" data-hot="10">
                                    ...
                                    <c:forEach var="comment" items="${COMMENT_LIST }">
                                        <li class="comment-container " data-val="{commentid:104863626}">
                                            <div class="portrait-container">
                                                <div class="portrait">
                                                    <img src="images/a6e4a0e8713e6cdb38cce157fb972f0d310610.jpg" alt="">
                                                </div>
        ...
        <div class="related">
            <div class="module">
                ...
                <div class="mod-content">
                    <dl class="news-list">
                        <dd class="news-item" data-act="new-click" data-val="{newsid:44184}">
                            <div class="news-img">
                                <a href="/films/news/44184" target="_blank">
                                    <img class="images/loading_2.e3d934bf.png">
                                    <img class="news-img-detail" src="images/6477ea5b768a18040883892198b0c46a260246.jpg">
                                </a>
                            </div>
                            <div class="news-main">
                                <div class="news-title">
                                    <a href="/films/news/44184" target="_blank">林允带病工作，拍照时仰头狂笑，网友：露22颗牙齿是怎么做到的！</a>
                                </div>
                                <div class="news-info">
                                    <span class="news-source">猫眼电影</span><!--
        --><span><i class="news-icon news-icon-views"></i>5935</span><!--
        --><span><i class="news-icon news-icon-comments"></i>4</span>
                                </div>
                            </div>
                        </dd>
                        <dd class="news-item" data-act="new-click" data-val="{newsid:42721}">
                            <div class="news-img">
                                <a href="/films/news/42721" target="_blank">
                                    <img class="news-img-default" src="images/loading_2.e3d934bf.png">
                                    <img class="news-img-detail" src="images/b67f1eeaaae0477c0ffada2a4fc98bbe1668950.jpg">
                                </a>
                            </div>
                            <div class="news-main">
                                <div class="news-title">
                                    <a href="/films/news/42721" target="_blank">吴亦凡单曲《中国魂》正式上线，展现高度文化自信</a>
                                </div>
                                <div class="news-info">
                                    <span class="news-source">猫眼电影</span><!--
        --><span><i class="news-icon news-icon-views"></i>3155</span><!--
        --><span><i class="news-icon news-icon-comments"></i>19</span>
                                </div>
                            </div>
                        </dd>
                        <dd class="news-item" data-act="new-click" data-val="{newsid:42263}">
                            <div class="news-img">
                                <a href="/films/news/42263" target="_blank">
                                    <img class="news-img-default" src="images/loading_2.e3d934bf.png">
                                    <img class="news-img-detail" src="images/977125bef9016058171ae49a6b44ec233957137.jpg">
                                </a>
                            </div>
                            <div class="news-main">
                                <div class="news-title">
                                    <a href="/films/news/42263" target="_blank">吴亦凡发布会遇“难题”  霸气直言：中国风就是国际化</a>
                                </div>
                                <div class="news-info">
                                    <span class="news-source">猫眼电影</span><!--
        --><span><i class="news-icon news-icon-views"></i>3745</span><!--
                        ...
                        <dl class="movie-list">
                            <dd>
                                <div class="movie-item">
                                    <a href="/films/248616" target="_blank" data-act="movie-click" data-val="{movieid:248616}">
                                        <div class="movie-poster">
                                            <img class="poster-default" src="images/loading_2.e3d934bf.png">
                                            <img src="images/1c9aa3810331787255b48217954b140c330868.jpg">
                                        </div>
                                    </a>
                                    <div class="movie-ver"></div>
                                </div>
                                <div class="channel-detail movie-item-title" title="爵迹">
                                    <a href="/films/248616" target="_blank" data-act="movies-click" data-val="{movieId:248616}">爵迹</a>
                                </div>
                                <div class="channel-detail channel-detail-orange"><i class="integer">7.</i><i class="fraction">8</i></div>

                            </dd><dd>
                            <div class="movie-item">
                                <a href="/films/1229298" target="_blank" data-act="movie-click" data-val="{movieid:1229298}">
                                    <div class="movie-poster">
                                        <img class="poster-default" src="images/loading_2.e3d934bf.png">
                                        <img src="images/d04607a2190d65b09ca5e62effe39d99268886.jpg">
                                    </div>
                                </a>
                                <div class="movie-ver"></div>
                            </div>
                            <div class="channel-detail movie-item-title" title="东方神娃之神魔对决">
                                <a href="/films/1229298" target="_blank" data-act="movies-click" data-val="{movieId:1229298}">东方神娃之神魔对决</a>
                            </div>
                            <div class="channel-detail channel-detail-orange">暂无评分</div>

                        </dd><dd>
                            <div class="movie-item">
                                <a href="/films/246594" target="_blank" data-act="movie-click" data-val="{movieid:246594}">
                                    <div class="movie-poster">
                                        <img class="poster-default" src="images/loading_2.e3d934bf.png">
                                        <img src="images/0e2db81619bd248a2321fa7136bf729f165852.jpg">
                                    </div>
                                </a>
                                <div class="movie-ver"></div>
                            </div>
                            <div class="channel-detail movie-item-title" title="精灵王座">
                                <a href="/films/246594" target="_blank" data-act="movies-click" data-val="{movieId:246594}">精灵王座</a>
                            </div>
                            <div class="channel-detail channel-detail-orange">暂无评分</div>

                        </dd><dd>
                            <div class="movie-item">
                                <a href="/films/359377" target="_blank" data-act="movie-click" data-val="{movieid:359377}">
                                    <div class="movie-poster">
                                        <img class="poster-default" src="images/loading_2.e3d934bf.png">
                                        <img src="images/c26936e4ee662c2ceede7b50971935a2391260.jpg">
                                    </div>
                                </a>
                                <div class="movie-ver"></div>
                            </div>
                            <div class="channel-detail movie-item-title" title="罗小黑战记">
                                <a href="/films/359377" target="_blank" data-act="movies-click" data-val="{movieId:359377}">罗小黑战记</a>
                            </div>
                            <div class="channel-detail channel-detail-orange">暂无评分</div>
                            ...
                            <div class="movie-item">
                                <a href="/films/1227585" target="_blank" data-act="movie-click" data-val="{movieid:1227585}">
                                    <div class="movie-poster">
                                        <img class="poster-default" src="images/loading_2.e3d934bf.png">
                                        <img src="images/3b1be37a07bf9edfd16ec60cd38de65d10758446.jpg">
                                    </div>
                                </a>
                                <div class="movie-ver"></div>
                            </div>
                            ...
                            <div class="movie-item">
                                <a href="/films/610697" target="_blank" data-act="movie-click" data-val="{movieid:610697}">
                                    <div class="movie-poster">
                                        <img class="poster-default" src="images/loading_2.e3d934bf.png">
                                        <img src="images/5f208537ebc0d767ea153217f6a81a8d189246.jpg">
                                    </div>
                                </a>
                                <div class="movie-ver"></div>
                            </div>
                            <div class="channel-detail movie-item-title" title="小兵张嘎">
                                <a href="/films/610697" target="_blank" data-act="movies-click" data-val="{movieId:610697}">小兵张嘎</a>
                            </div>
                            <div class="channel-detail channel-detail-orange">暂无评分</div>
...
<div id="comment-form-container" class="jBox-wrapper jBox-Modal jBox-Default" style="position: fixed; display: none; opacity: 1; z-index: 10000; left: 50%; top: 50%; margin-left: -285px; margin-top: -235px;"><div class="jBox-container"><div class="jBox-content" style="width: 550px; height: 450px;">
    <form id="comment-form" action="commentCtrl" method="post">
        <div class="score-msg-container">
            ...
            <select name="grade">
                <option value ="1.0分">1.0分</option>
                <option value ="2.0分">2.0分</option>
                <option value="3.0分">3.0分</option>
                <option value="4.0分">4.0分</option>
                <option value="5.0分">5.0分</option>
                <option value="6.0分">6.0分</option>
                <option value="7.0分">7.0分</option>
                <option value="8.0分">8.0分</option>
                <option value="9.0分">9.0分</option>
                <option value="10.0分">10.0分</option>
        ...
        <div class="content-container focus">
            <textarea placeholder="快来说说你的看法吧" name="content" id="values" cols="30" rows="10"></textarea>
